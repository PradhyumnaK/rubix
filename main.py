...
def detect_face(bgr_image_input):
    ...
    if len(blob_colors) == 9:
        ...
        for i in range(9):
            # print(blob_colors[i])
            if blob_colors[i][0] > 120 and blob_colors[i][1] > 120:
                blob_colors[i][3] = 1
                face[i] = 1
            elif blob_colors[i][0] < 100 and blob_colors[i][1] > 120 and blob_colors[i][2] > 120 and np.abs(blob_colors[i][1] - blob_colors[i][2]) < 30:
                blob_colors[i][3] = 2
                face[i] = 2
            elif blob_colors[i][0] > 250:
                blob_colors[i][3] = 3
                face[i] = 3
            elif blob_colors[i][1] > blob_colors[i][0] and blob_colors[i][1] > blob_colors[i][2] and np.abs(blob_colors[i][0] - blob_colors[i][2]) < 0:
                blob_colors[i][3] = 4
                face[i] = 4
                ...
                blob_colors[i][3] = 5
                face[i] = 5
            elif blob_colors[i][2] > blob_colors[i][1] > blob_colors[i][0] and blob_colors[i][2] > 120:
                blob_colors[i][3] = 6
                face[i] = 6
        # print(face)
...
def main():
    ...
    while True:
        ...
        # print(front_face)
        # print(up_face)
        cv2.putText(bgr_image_input, "Show Down Face", (50, 50), cv2.FONT_HERSHEY_SIMPLEX,
                    2, (0, 0, 255), 3)
        videoWriter.write(bgr_image_input)
        cv2.imshow("Output Image", bgr_image_input)
        # print(count)
